        ...
        <section id="speakers" className="py-16 md:py-24 bg-secondary">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="mt-16 text-center">
                     <Button size="lg" asChild variant="outline" className="text-base sm:text-lg px-4 sm:px-8 py-6 rounded-full border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground">
